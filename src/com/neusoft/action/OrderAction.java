...
public class OrderAction extends ActionSupport implements ModelDriven<Order>{
	...
	public String exUpdateOrderByOrderId(){
		...
		if(rentTime!=null&&returnTime!=null){
			 //根据日期计算价钱
			 Long price=(Math.abs(returnTime.getTime()-rentTime.getTime())/ (1000 * 60 * 60 * 24))*Integer.parseInt(n.getCar().getDailyPrice());
			 if(price!=0){
	...
	public String delete(){
		...
		//orderService.update(n);
		ActionContext.getContext().put("url", "/order_order.do");//这个方法是以键值对的方式添加进去的相当于request.setA
		return "redirect";
	}
